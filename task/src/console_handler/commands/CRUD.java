...
public enum CRUD {
    DELETE("-rm") {
        ...
        public ResultSet execute(Data data, String tableName, String command, PlayerMap cash) throws SQLException {
            ...
            DataBaseCommunication.executeUpdate(Requests.getDeleteDataRequest(tableName, collumns, values), data.getConnection());
    ...
    READ("-get") {
        ...
        public ResultSet execute(Data data, String tableName, String command, PlayerMap cash) throws SQLException {
            ...
            ResultSet rs = DataBaseCommunication.getResultSet(Requests.getQueryRequest(tableName, collumns, values), data.getConnection());
    ...
    CREATE("-add") {
        ...
        public ResultSet execute(Data data, String tableName, String command, PlayerMap cash) throws SQLException {
            ...
            DataBaseCommunication.executeUpdate(Requests.getInsertRequest(tableName, collumns, values), data.getConnection());
            return null;
        }
    },
    UPDATE("-chng") {
        ...
        public ResultSet execute(Data data, String tableName, String command, PlayerMap cash) throws SQLException {
            ...
            DataBaseCommunication.executeUpdate(Requests.getUpdateRequest(tableName, collumns1, values1, collumns2, values2), data.getConnection());
            return null;
        }
    };
