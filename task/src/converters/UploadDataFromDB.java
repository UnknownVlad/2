...
public class UploadDataFromDB {
    ...
    public static List<Player> upload(Data data) throws SQLException {
        ...
        ResultSet set = DataBaseCommunication.getResultSet(Requests.getQueryAllDataRequest(data.getPlayerTabelName()),data.getConnection());
        ...
        for (Integer key:pn.keySet()) {
            ...
            set = DataBaseCommunication.getResultSet(Requests.getQueryRequest(data.getCurrenciesTabelName(), "playerId", Integer.toString(key)), data.getConnection());
            ...
            set = DataBaseCommunication.getResultSet(Requests.getQueryRequest(data.getItemsTabelName(), "playerId", Integer.toString(key)), data.getConnection());
            ...
            set = DataBaseCommunication.getResultSet(Requests.getQueryRequest(data.getProgressesTabelName(), "playerId", Integer.toString(key)), data.getConnection());
